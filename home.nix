...
# my-chromium-browser = pkgs.chromium.browser.overrideAttrs (attrs: {
#   patches = attrs.patches ++ [ ./patches/tainted-canvas.patch ];
# });

# my-chromium = pkgs.chromium.overrideAttrs (attrs: {
#   browser = my-chromium-browser;
# });

  my-krita = pkgs.krita.overrideAttrs (attrs: {
    patches = (attrs.patches or [ ]) ++ [ ./patches/krita-pan-action.patch ];
  });
