...
let
  ...
  mkFHSEnv = onlyofficeUnwrapped: pkgs.buildFHSUserEnvBubblewrap (rec {
    name = "onlyoffice";
    runScript = "/nix/store/hx7dd7l5mby97gmyz585yxvhv5mg22wm-onlyoffice-desktopeditors-8.0.0/bin/DesktopEditors";
    ...
    extraInstallCommands = ''
      ...
      substituteInPlace $out/share/applications/onlyoffice-desktopeditors.desktop \
        --replace "${onlyofficeUnwrapped}/bin/onlyoffice-desktopeditors" "/nix/store/rcg087qmai5x8p3y40ww8swflc3yjjpp-onlyoffice-bwrap"
    '';
  });
in
